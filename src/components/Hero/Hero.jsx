...
const Hero = ({ data }) => {
  const { title, subTitle1,subTitle2,subTitle3,subTitle4,location, ImgLink, phone, email, socialData } = data;
  useEffect(() => {
    const handleScroll = () => {
          ...
          <div className="col-lg-7 col-xl-7 col-xxl-6">
            <div className="hb-text">
              ...
              <p className="lead" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">
                <ReactTyped strings={[subTitle1,subTitle2,subTitle3,subTitle4]} typeSpeed={70} loop/>
              </p>
              <p className="lead" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400">{perser(location)}</p>
